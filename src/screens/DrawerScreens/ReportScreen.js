  ...
  return (
    <ScrollView style={{backgroundColor:"#f5f5f5"}}>
      <View style={{paddingHorizontal:16}}>
        ...
        {/* blood card */}
        <View style={{backgroundColor:'#6295E2', borderRadius:14, marginVertical:50}}>
        ...
        <CustomTextBold style={{color:"#CDCFCE", fontSize:25}}>Previous Results</CustomTextBold>

        {/* timer blue card */}
        <View 
          style={{maxWidth:500, marginTop:10, width:"100%", height:310, borderRadius:20, backgroundColor:"#6295E2", alignItems:'center', justifyContent:'center'}}>
