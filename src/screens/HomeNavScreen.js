...
const HomeNavScreen = ({navigation}) => {
  ...
  const CustomHeader = ({ navigation1, route }) => {
    return (
      <View style={styles.header}>
        <CustomTextBold style={{fontSize:28}}>
          {/* {route.name} */}
          </CustomTextBold>
        <TouchableOpacity onPress={() => navigation1.toggleDrawer()} style={{width:40, height:40, borderRadius:12, padding:10, backgroundColor:'#66CA98', justifyContent:'center', alignItems:'center'}}>
  ...
  return (
    <>
        ...
        <Drawer.Navigator style={{flex:1}}
          screenOptions={{
              ...
              headerTitleStyle: {fontFamily:"Poppins", alignItems:'center', fontSize:28, paddingVertical:10},
              // headerLeft: () => 
              ...
              <View  style={{ justifyContent:'flex-end'}}>
                <View style={{marginLeft:30, padding:10}}>
                  <TouchableOpacity style={{ flexDirection:'row', justifyContent:"space-between", alignItems:'center'}}>
                    ...
                    <Text style={{width:35, height:25, backgroundColor: "#66CA98", textAlign:'center', fontSize:12, color:"#fff", borderRadius:4, padding:4}}>1</Text>
                  </TouchableOpacity>
                ...
                <View style={{display:'flex', flexDirection:'row', justifyContent: 'space-between', backgroundColor: '#66ca98', borderRadius:8, paddingHorizontal:16, paddingVertical:24, margin:20}} className="bg-acpGreen">
                  <View style={{display:'flex', flexDirection:'row', justifyContent: 'space-between'}}>
                    ...
                    <View>
                      <Text style={{fontSize:14, color:"#fff"}}>Full name</Text>
                      <Text style={{fontSize:12, color:"#fff"}}>fullname@gmail.com</Text>
                    </View>
                  </View>
    ...
    >
      ...
      <Drawer.Screen name='ReportScreen' component={ReportScreen} 
        options={{title:"Report", drawerIcon: ({color}) => <Svg
        width={20}
        height={20}
        viewBox="0 0 20 20"
      >
